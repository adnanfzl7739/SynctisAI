      ...
      {messages.length === 0 && !isLoading ? (
        <div className="h-full flex flex-col items-center justify-center gap-4 text-center">
          <div className="flex flex-col gap-1.5">
            <h1 className="text-[20px] font-semibold text-slate-200 tracking-tight">SynctisAI</h1>
            <h3 className="text-[15px] font-semibold text-slate-400 tracking-tight">Tell me what you need.</h3>
            <p className="text-[13px] text-slate-600 max-w-[260px] leading-relaxed">One place for chat, code, search, and documents..</p>
          </div>

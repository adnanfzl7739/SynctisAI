...
import { Send, Paperclip, Square, Zap, MessageSquare, Code2, Globe, FileText, X } from "lucide-react";
...
export default function ChatInput({
  ...
  const placeholders = {
    ...
    chat: "Chat with SynctisAI...",

    coding: "Describe what you want to build...",
...
`}
...

        {
          ...
          selectedFile && (
            ...
            <div className="my-3">
              ...
              <div className="inline-flex items-center gap-2 rounded-xl border border-[#2A2A30] bg-[#1A1A1E] px-3 py-2">
                ...
                >
                  ...
                  <X
                    ...
                    className="text-[#9CA3AF] hover:text-[#E5E5E0]"
        ...
        <textarea
          ...
          rows={3}
          disabled={isLoading}
          className="w-full bg-transparent outline-none resize-none text-[14px] text-[#E5E5E0] placeholder:text-[#6B6B70] leading-relaxed [scrollbar-width:none] [&::-webkit-scrollbar]:hidden disabled:opacity-50"
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            />
            <button className="flex items-center justify-center w-8 h-8 rounded-lg text-[#9CA3AF] hover:text-[#E5E5E0] hover:bg-[#1A1A1E] border border-transparent hover:border-[#2A2A30] transition-all duration-150 bg-transparent cursor-pointer"
              onClick={() =>
...
`}
    ...
    ${isLoading
      ...
      <p className="text-center text-[10.5px] text-[#6B6B70] mt-2.5">
        SynctisAI can make mistakes. Verify important info.
      </p>
    </div>
  );
}